...
public class IndentApprovalPage extends HISWebsiteBasePage{
	...
	public void changeQuantityAgainSelectedItem(String medicine, String quantity) {
		try {
		driver.findElement(By.xpath("//td[contains(text(),'"+medicine+"')]//following::input[@name='txtNewQuantity']")).clear();
		driver.findElement(By.xpath("//td[contains(text(),'"+medicine+"')]//following::input[@name='txtNewQuantity']")).sendKeys(quantity);
	...
	public String getValueOfIndentNoFromApproveIndentPopup() {
