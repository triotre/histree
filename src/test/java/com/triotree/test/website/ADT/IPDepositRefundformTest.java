...
public class IPDepositRefundformTest  extends TTWebsiteBaseTest
{
	...
	{
		test=extent.createTest("AdtIPDepositRefundformTest", "This test case is verifies ADT IPDeposit Refund form Test");
		test.assignCategory("ADT IP Deposit");
...
//		ipdepositrefund.clickoncredticardradiobutton(test);
...
//		ipdepositrefund.clickonRefundAmount(test);
//		ipdepositrefund.clickonRefundcreditcardradiobutton();
//		ipdepositrefund.enterRefundDDchecknumber(test,"123456789");
//		ipdepositrefund.selectRefundCreditCardName(test,"MASTERCARD");
//		ipdepositrefund.selectRefundCreditCardBankName(test,"Allahabad Bank");
//		ipdepositrefund.enterRefundCreditCardBatchNumber(test,"1234");
