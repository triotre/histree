...
public class PatientRegistrationTest extends TTWebsiteBaseTest{
	...
	public void patientRegistrationAliasName() throws Throwable {
		...
		hisHomePage.selectStationAndClickOnYes("Front Office");
		frontOfficeHomePage.clickOnAddPatientAndSelectAnOption("Patient Registration");
		patientRegistrationPage.selectActualDemographicsCheckbox();
		...
		patientRegistrationPage.enterfirstnameatactualpatientdetails("Automation");
	...
	public void patientRegistrationSimilarSoundingClosePopupTest() throws Throwable {
		...
		//assertTrue(patientRegistrationPage.verifyPossibleDuplicateAlertPresence("Possible Duplicate Alert"), "Possible Duplicate ALert Not showing up");
		patientRegistrationPage.closePossibleAlertBox();
	...
	public void frontOfficeCapturePurposeOfVisitOnRegistrationTest() throws Throwable {
		...
		patientRegistrationPage.selectPurposeOfVisit("Lab test only");
